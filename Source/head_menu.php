...
<body>
    <div class="container pb-2">
        ...
        <div class="header-menu" id="header-menu" style="display:flex">

            <nav class="navbar navbar-expand-lg " style="background-color: #aba247">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle" href="#" id="danhmucsanpham" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i style="font-size: 20px; margin: 0px 2px; line-height:0px" class="fa-solid fa-list"></i>
                        Product portfolio
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="danhmucsanpham">
                            <li><a class="dropdown-item" href="#">STUDENT STATIONERY</a>
                                <ul>
                            ...
                            <li><a class="dropdown-item" href="#">OFFICE STATIONERY</a>
                                ...
                                <ul>
                                    ...
                                    <li><a class="dropdown-item" href="#">Office decoration</a></li>
                            ...
                            <li><a class="dropdown-item " href="#">STATIONERY ACCESSORY</a>
                                <ul>
                            ...
                            <li><a class="dropdown-item" href="#">BACKPACK-BOOK BAG</a>
                                <ul>
                                    <li><a class="dropdown-item" href="#">Sub Item 1</a></li>
                                    <li><a class="dropdown-item" href="#">Sub Item 2</a></li>
                                    <li><a class="dropdown-item" href="#">Sub Item 3</a></li>
                            ...
                            <li><a class="dropdown-item" href="#">OFFICE EQUIPMENT</a>
                                <ul>
                                    <li><a class="dropdown-item" href="#">Sub Item 1</a></li>
                                    <li><a class="dropdown-item" href="#">Sub Item 2</a></li>
                                    <li><a class="dropdown-item" href="#">Sub Item 3</a></li>
            ...
            <div class="col px-3" style="line-height: 53px; ">

                <div class="block-slogan">
                    <span id="block-slogan1"  onclick="changeLine()">
            ...
            <div class="col" id="block-col">
                ...
                <div class="block-menu">
                    ...
                    <a href="/lien-he" title="Liên hệ" id="block-menu">
...
<script>
    // ___________________________________________________Danh mục sản phẩm________________________________
    $(document).ready(function() {
        // Ẩn menu dropdown khi không được nhấp vào
        $(document).on('click', function(e) {
            if (!$('.navbar-nav .dropdown-menu').is(e.target) && $('.navbar-nav .dropdown-menu').has(e.target).length === 0) {
                $('.navbar-nav .dropdown-menu').hide();
            }
        });

        // Xử lý sự kiện click cho mục dropdown
    ...
    // ____________________________chữ chuyển động__________________________
    // var index = 0;
    // var slogans = ["  Stationery lựa chọn số 1 ", " Stationery-1-2-3-Zô ", "   Stationery-1-2-3-Uống "];

    // function changeLine() {
    //     var sloganElement = document.querySelector('.block-slogan span');
    ...
    var index = 0;
        ...
        function changeLine() {
            var sloganElement = document.querySelector('.block-slogan #block-slogan1');
            sloganElement.innerText = slogans[index];
            index++;
            if (index >= slogans.length) {
                index = 0;
            ...
            sloganElement.style.color = randomColor;
        }

        setInterval(changeLine, 1500);
