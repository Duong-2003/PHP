            ...
            <div class="left">
                ...
                <form method="POST" action="/users/register">
                    ...
                    <div class="input-block">
                        ...
                        <input type="text" class="input" id="name" name="name" required autofocus placeholder="Username">
                    ...
                    <div class="input-block">
                        <input class="input" type="password" id="password_confirmation" name="password_confirmation" required placeholder="Password">
