...
<meta charset="UTF-8">
    ...
    <title> Stationery Website Login Page </title>
</head>
<style>
    .form {
  display: flex;
...
<div class="container">
    <div class="row">
        ...
        <form class="form" method="post" action="../Website/login_process.php">
           
        <div class="" id=""style="color:#db7b7b;text-align:center;font-size:30px;margin:20px 0">LOG IN TO ACCOUNT</div>
    ...
    <div class="flex-row">
      <button class="btn google" style="color:#518EF8">
...
<path style="fill:#F14336;" d="M419.404,58.936l-82.933,67.896c-23.335-14.586-50.919-23.012-80.471-23.012
	...
	C318.115,0,375.068,22.126,419.404,58.936z"></path>
      ...
      </button><button class="btn apple" style="color:#518EF8">
